...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  a { color:#111; }
  .hidden { display:none; }
  .appfoot { margin:6px 2px 30px; padding-top:14px; border-top:1px solid var(--line);
             display:flex; flex-wrap:wrap; gap:6px 16px; align-items:center; justify-content:center;
             font-size:12.5px; color:var(--muted); }
  .appfoot a { color:#2B3036; text-decoration:none; }
  .appfoot a:hover { text-decoration:underline; }
  .appfoot .sepdot { color:#c2c6cb; }
...
<div class="wrap">
  ...
  <footer class="appfoot">
    <a href="https://tribecatest123.github.io/tribeca-task-tool/stakeholder-overview.html" target="_blank" rel="noopener">Stakeholder deck</a>
    <span class="sepdot">·</span>
    <a href="https://tribecatest123.github.io/tribeca-task-tool/architecture-flow.html" target="_blank" rel="noopener">Architecture &amp; flow</a>
    <span class="sepdot">·</span>
    <a href="https://github.com/Tribecatest123/tribeca-task-tool" target="_blank" rel="noopener">Source on GitHub</a>
  </footer>
</div>
